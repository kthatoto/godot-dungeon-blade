extends SceneTree
## Scene builder — run: timeout 60 godot --headless --script scenes/build_archer.gd

func _initialize() -> void:
	print("Building archer scene...")

	var root := CharacterBody2D.new()
	root.name = "Archer"
	root.set_script(load("res://scripts/archer_controller.gd"))
	...
	print("Saved: res://scenes/archer.tscn")
	quit(0)
